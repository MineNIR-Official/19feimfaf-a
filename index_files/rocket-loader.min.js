!function() {
        ...
        t.prototype.insertContentInHead = function() {
            ...
            o.body.childNodes.length) {
                for (var i = Array.prototype.slice.call(o.body.childNodes), a = this.insertionPointMarker.nextSibling; a; )
                    i.push(a),
                    a = a.nextSibling;
                document.body || I.call(document, "<body>"),
                r(i, document.body)
            }
        }
        ,
    ...
    !function() {
        ...
        if (t) {
            ...
            b(n),
            M.updateInlineHandlers(),
            n.bailout ? S(n.nonce) : (g(),
            w(n.nonce))) : e("Activator script doesn't have settings. No scripts will be executed.")
        } else
            e("Can't obtain activator script. No scripts will be executed.")
    }()
}();

$('header a, .sidenav a').click(function()
{
	if(typeof($(this).data('href')) != "undefined" && $(this).data('href') !== null)
	{
		$('#before-load').find('i').show().end().show();
		$('.main').load($(this).data('href'));

		if($(this).data('href') !== '/Main/items')
		{
